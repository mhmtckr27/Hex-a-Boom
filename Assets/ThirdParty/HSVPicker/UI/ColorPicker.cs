...
namespace HSVPicker
{
    ...
    {
        public OnConfirmColorEvent onConfirmColor = new OnConfirmColorEvent();
        public Image assignedColorImage; 
        ...
        public void ToggleVisibility(bool enable)
        {
            if (!enable)
            {
                onConfirmColor.RemoveAllListeners();
            }
        ...
        {
            onConfirmColor.Invoke(CurrentColor);
            ToggleVisibility(false);
        }
    }
...
public class OnConfirmColorEvent : UnityEvent<Color>
{
